...
INSERT INTO flash_items (id, name, price, original_price, total_stock, stock, start_time, end_time, create_time,
                         update_time, deleted)
VALUES (1, '旗舰手机 Pro', 699900, 899900, 50, 50,
        CURRENT_TIMESTAMP - INTERVAL '10' MINUTE, CURRENT_TIMESTAMP + INTERVAL '1' DAY, CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 0),
       (2, '无线降噪耳机', 79900, 129900, 5, 5,
        CURRENT_TIMESTAMP - INTERVAL '10' MINUTE, CURRENT_TIMESTAMP + INTERVAL '1' DAY, CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 0),
       (3, '智能手表限量款', 149900, 199900, 20, 20,
        CURRENT_TIMESTAMP + INTERVAL '1' DAY, CURRENT_TIMESTAMP + INTERVAL '2' DAY, CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 0),
       (4, '游戏主机套装', 299900, 399900, 10, 10,
        CURRENT_TIMESTAMP - INTERVAL '2' DAY, CURRENT_TIMESTAMP - INTERVAL '1' DAY, CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 0);
